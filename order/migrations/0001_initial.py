...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('maintenance_worker', '0001_initial'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_maintenance_worker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maintenance_worker', to='maintenance_worker.maintenanceworker')),
            ],
        ),
    ]
